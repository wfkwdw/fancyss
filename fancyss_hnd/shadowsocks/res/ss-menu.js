...
function LoadingSSProgress(seconds) {
	...
	if (action == 0) {
		...
		$("#loading_block2").html("<li><font color='#ffcc00'><a href='https://github.com/koolshare/rogsoft/tree/master/shadowsocks' target='_blank'></font>插件工作有问题？请到<em>GITHUB</em>提交issue...</font></li>");
	} else if (action == 1) {
